const TerminalConfiguration = {
  ...
  education: {
    ...
    desc: "Northeastern University, Boston MA | 2024 - 2026",
    CGPA: "3.92/4.0",
  },
  ls: {
  ...
  skills: {
    ...
    programming_languages: "Java, C#, JavaScript, TypeScript, C++",
  ...
  //   blog_url: "https://blog.mayukhsinha.com/",
  // },
  github: {
    gh_handle: "https://github.com/neu-msinha",
  },
  LinkedIn: {
